...
short SPPrintLine(SP_INPUT_DATA *Input) {
    ...
    SPLineSetup(OutputLine, "SUS-DSK4:", Input->NumberOfDiskSuspendedProcesses4,
    		Input->DiskSuspendedProcessPIDs4);
    SPLineSetup(OutputLine, "SUS-DSK5:", Input->NumberOfDiskSuspendedProcesses5,
    		Input->DiskSuspendedProcessPIDs5);
    SPLineSetup(OutputLine, "SUS-DSK6:", Input->NumberOfDiskSuspendedProcesses6,
    		Input->DiskSuspendedProcessPIDs6);
    SPLineSetup(OutputLine, "SUS-DSK7:", Input->NumberOfDiskSuspendedProcesses7,
    		Input->DiskSuspendedProcessPIDs7);
    SPLineSetup(OutputLine, "SUS-DSK8:", Input->NumberOfDiskSuspendedProcesses8,
    		Input->DiskSuspendedProcessPIDs8);
